    ...
    move() {
        ...
        if (this.x > width) {
            ...
            if (windowWidth >= 1200) {
                ...
                this.flag = random(1.5, 3.5);

            } else if (windowWidth >= 800) {
                this.flag = random(2, 4);

            } else if (windowWidth >= 357) {
                this.flag = random(2.5, 4.5);
...
class chicks {
    ...
    constructor() {
        ...
        if (windowWidth >= 1200) {
            ...
            this.width = this.img.width / 1.8;
            this.height = this.img.height / 1.8;
...
class hens {
    constructor() {
        ...
        if (windowWidth >= 1200) {
            ...
            this.width = this.img.width / 2.6;
            this.height = this.img.height / 2.6;
